...
export class HomePage {
  ...
  hr1(){
    this.navCtrl.navigateForward("tresdos");
  }
  hr2(){
    this.navCtrl.navigateForward("seiscuatro");
  }
  hr3(){
    this.navCtrl.navigateForward("nueveseis");
  }
  hr4(){
    this.navCtrl.navigateForward("unodoscuatro");
  }
}
/*
  EPE1:any;
